...
var (
	...
	ErrQuickAddMissingAccountInfo                                  = NewNormalError(NormalSubcategoryTransaction, 42, http.StatusBadRequest, "quick add requires either accountId or accountName")
	ErrQuickAddAccountNotFoundByName                               = NewNormalError(NormalSubcategoryTransaction, 43, http.StatusBadRequest, "no account found matching the given name")
)
